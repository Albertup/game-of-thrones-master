...
const CharactersPage = () => {
  ...
  <div className='b-background'>
    <Header search={searchCharacters} ></Header>
    <div className='b-personajes'>
      
        <SimpleBar forceVisible="y" className='simplebar-track\simplebar-vertical simplebar-scrollbar simplebar-content simplebar-placeholder'>
